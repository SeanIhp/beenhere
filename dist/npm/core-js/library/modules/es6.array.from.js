"use strict";var exports=module.exports={};var ctx = require('./_ctx.js');
...
var createProperty = require('./_create-property.js');
var getIterFn = require('./core.get-iterator-method.js');

$export($export.S + $export.F * !require('./_iter-detect.js')(function (iter) { Array.from(iter); }), 'Array', {
